...
public class HbaseSinkFunction extends RichSinkFunction<Tuple2<JSONObject, TableProcessDim>> {
    ...
    // 将流中的数据写出到Hbase
    @Override
    public void invoke(Tuple2<JSONObject, TableProcessDim> tuple2) throws Exception {
