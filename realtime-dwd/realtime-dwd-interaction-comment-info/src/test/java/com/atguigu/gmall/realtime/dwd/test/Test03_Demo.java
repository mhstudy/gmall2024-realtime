...
public class Test03_Demo {
    public static void main(String[] args) {
        ...
        // TODO 2.检查点相关的设置（略）
        // TODO 3.从kafka的first主题中读取员工数据     创建动态表
        ...
        // TODO 4.从HBase表中读取部门数据    创建动态表
        tableEnv.executeSql("CREATE TABLE dept (\n" +
                " detpno string,\n" +
                " info ROW<dname string>,\n" +
                " PRIMARY KEY (detpno) NOT ENFORCED\n" +
                ") WITH (\n" +
                " 'connector' = 'hbase-2.2',\n" +
                " 'table-name' = 't_dept',\n" +
