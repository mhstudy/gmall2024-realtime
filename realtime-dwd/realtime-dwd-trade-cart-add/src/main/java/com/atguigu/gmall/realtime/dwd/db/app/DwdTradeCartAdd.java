...
public class DwdTradeCartAdd extends BaseSQLApp {
    public static void main(String[] args) {
        new DwdTradeCartAdd().start(10014, 4, Constant.TOPIC_DWD_TRADE_CART_ADD);
    }
    ...
    public void handle(StreamTableEnvironment tableEnv) {
        ...
        // TODO 过滤出加购数据 table='cart_info' and type='insert' 、 type='update' 并且修改是加购的商品数据，修改后的值比修改前的大
