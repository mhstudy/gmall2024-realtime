 ...
 * 取消订单事实表
 * 需要启动的进程
 *      zk、kafka、maxwell、DwdTradeCartAdd、DwdTradeOrderCancelDetail
 */
public class DwdTradeOrderCancelDetail extends BaseSQLApp {
    ...
    public void handle(StreamTableEnvironment tableEnv) {
        // TODO 设置状态保留时间
        tableEnv.getConfig().setIdleStateRetention(Duration.ofSeconds(30 * 60 + 5)); // 30分钟取消订单

        // TODO 从kafka的topic_db主题读取数据
